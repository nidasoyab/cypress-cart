...
describe('signUp', () => {  
  ...
  it('CheckOut', ()=>{
    ...
    cy.get('.style-module--payment-method-form--3finD > [data-testid=opt-form-with-error] > form > .opt-form-with-error__l-right-10 > .Label-module--label--2JSVv > .TextInput-module--input-wrapper--Kd-BG > [data-testid=first-name]').type('Ed')
    cy.get('.style-module--payment-method-form--3finD > [data-testid=opt-form-with-error] > form > .opt-form-with-error__l-left-10 > .Label-module--label--2JSVv > .TextInput-module--input-wrapper--Kd-BG > [data-testid=last-name]').type('San')
