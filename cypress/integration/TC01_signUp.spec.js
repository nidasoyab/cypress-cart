...
describe('signUp', () => {  
  ...
  it('CheckOut', ()=>{
    ...
    cy.get('.style-module--payment-method-form--3finD > [data-testid=opt-form-with-error] > form > .opt-form-with-error__zip > .Label-module--label--2JSVv > .TextInput-module--input-wrapper--Kd-BG > .TextInput-module--input--1_OT7').blur()
